...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_cities_detail(self):
        driver = self.driver
        driver.get("https://poupon.me")
        button = driver.find_element_by_xpath("//*[@id=\"navbarSupportedContent\"]/ul/li[6]/a/div")
        button.click()
        self.assertEqual(driver.current_url, "https://poupon.me/cities", "On cities page")
        time.sleep(5)
        ...
        self.assertEqual(driver.current_url, "https://poupon.me/cities/16", "On the city's page")
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div/div/h2")
        self.assertEqual(city.text, "Atlanta, GA", "Checking that the correct city is displayed")
    ...
    def test_cities_sorting(self):
        ...
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "Washington D.C.", "Checking that cities are sorted correctly")
        ...
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "New York City", "Checking that cities are sorted correctly")
        ...
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "Tupelo", "Checking that cities are sorted correctly")
    ...
    def test_cities_paging(self):
        ...
        #check the first page
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "Atlanta", "Checking that cities are paged correctly")

        #check the second page
        driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[1]/div/ul/li[3]/a").click()
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "Long Beach", "Checking that cities are paged correctly")
    ...
    def test_search(self):
        driver = self.driver
        driver.get("https://poupon.me")
        search = driver.find_element_by_xpath("//*[@id=\"navbarSupportedContent\"]/form/input")
        search.send_keys("ch")
        search.submit()
        time.sleep(5)

        artist = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div[2]/h4/a/span")
        self.assertEqual(artist.text, "2 Chainz", "Checking that artists are searched correctly")
        highlight = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div[2]/h4/a/span/strong")
        self.assertEqual(highlight.text, "Ch", "Checking that highlighting worked correctly")

        albums = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[1]/ul/li[2]/span")
        albums.click()
        time.sleep(5)
        album = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div[2]/h4/a/span")
        self.assertEqual(album.text, "True 2 da Game: Chopstick, Vol. 1 (Slowed & Chopped)", "Checking that albums are searched correctly")
        highlight = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div[2]/h4/a/span/strong[1]")
        self.assertEqual(highlight.text, "Ch", "Checking that highlighting worked correctly")

        news = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[1]/ul/li[3]/span")
        news.click()
        time.sleep(5)
        article = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div/div/div[2]/p[2]/h5/span")
        self.assertEqual(article.text, "I am Chance The Rapper, Chi-town rapper and part of the Save Money crew. AMA!", "Checking that articles are searched correctly")
        highlight = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/div/div/div/div[2]/p[2]/h5/span/strong[1]")
        self.assertEqual(highlight.text, "Ch", "Checking that highlighting worked correctly")

        cities = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[1]/ul/li[4]/span")
        cities.click()
        time.sleep(5)
        city = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/table/thead/tbody/tr/td[1]/a/span")
        self.assertEqual(city.text, "Chattanooga", "Checking that cities are searched correctly")
        highlight = driver.find_element_by_xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div/div[2]/table/thead/tbody/tr/td[1]/a/span/strong")
        self.assertEqual(highlight.text, "Ch", "Checking that highlighting worked correctly")
